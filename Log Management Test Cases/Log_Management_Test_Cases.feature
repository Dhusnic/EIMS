Feature: Compliance reports - file integrity Report
Background:
Given user logged in
When user navigates to Report
And clicks on it

@Log_Management_File_Integrity_Report_8538
...
@Log_Management_File_Integrity_Report_8538
Scenario: Verfiy the file integrity report card
    Given Navigate to report
    ...
    Then user can be able to see the file integrity report card in log management category

@Log_Management_File_Integrity_Report_8538
Scenario: Verify the Indices fields data display
    Given Navigate to report
    When a user click on the Add Report
    And click on user activity report card
...
@Log_Management_File_Integrity_Report_8538
Scenario: Verify the Event Column fields data display
    Given Navigate to report
    When a user click on the Add Report
    And click on user activity report card
    Then now the user can be able to see the configuration page
    Then user can be able to see the Event Column fields
    And user click on the Event Column fields
    Then user can see the Event column data like "file created","file updates", "file deleted"
...
@Log_Management_File_Integrity_Report_8538
Scenario: Verify the asset custom filters
    Given Navigate to report
    When a user click on the Add Report
    And click on user activity report card
    Then now the user can be able to see the configuration page
...
@Log_Management_File_Integrity_Report_8538
Scenario: Verify the asset custom data displays
    Given Navigate to report
    When a user click on the Add Report
    And click on user activity report card
    Then now the user can be able to see the configuration page
